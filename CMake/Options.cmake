...
option(Nezumi_BUILD_EXAMPLES "Build code examples" OFF)
option(Nezumi_BUILD_TESTS "Build tests" OFF)

set(Nezumi_AS_SUBPROJECT OFF)
if(CMAKE_CURRENT_SOURCE_DIR STREQUAL CMAKE_SOURCE_DIR)
    set(Nezumi_AS_SUBPROJECT ON)
endif()

set(Nezumi_CMAKE_MODULE_PATH ${CMAKE_CURRENT_SOURCE_DIR}/CMake)
# include(${Nezumi_CMAKE_MODULE_PATH}/Packages.cmake)

set(Nezumi_TARGET_NAME ${PROJECT_NAME})
set(Nezumi_INCLUDE_BUILD_DIR "${PROJECT_SOURCE_DIR}/Include/")
set(Nezumi_INCLUDE_INSTALL_DIR ${CMAKE_INSTALL_INCLUDEDIR})
set(Nezumi_BINARY_DIR ${CMAKE_CURRENT_BINARY_DIR})
